...
class VCHomeAddChild : UIViewController, UINavigationControllerDelegate, UITextFieldDelegate, UIPickerViewDataSource, UIPickerViewDelegate{
    ...
    @IBOutlet var tfBankRoutingNumber: UITextField!
    @IBOutlet var tfBankAccountNumber: UITextField!
    ...
    func callSignUpForChild(firstName: String,email: String,password: String,childAvatar: String,phoneNumber: String){
        ...
        callSignUpApiForChild(firstName: firstName,email: email,password: password,childAvatar: self.childImageUrl,phoneNumber: phoneNumber, success: {
            ...
            if (errorcode == "9000"){
                ...
                self.password.text = ""
                self.confirmPassword.text = ""
                self.tfBankRoutingNumber.text = ""
                self.tfBankAccountNumber.text = ""
                self.userImageView.image = EarnItImage.defaultUserImage()
                self.hideLoadingView()
            }else {
