...
// 
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        childCell.btnDeleteChildRow.addTarget(self, action: #selector(deleteChildRowButtonAction), for: UIControlEvents.touchUpInside)
        return childCell
    }
    ...
    //MARK: Delete Child Row
    
    func deleteChildRowButtonAction(_ sender: Any) {
        print("print child ")
        let btnDelete:UIButton = sender as! UIButton
        self.idForDeleteChild = btnDelete.tag
        let alert = showAlertWithOption(title: "Are you sure you want to delete \(btnDelete.titleLabel!.text!) from your account? All data will be erased.", message: "")
        alert.addAction(UIAlertAction(title: "Cancel", style: UIAlertActionStyle.cancel, handler: nil))
        alert.addAction(UIAlertAction(title: "OK", style: UIAlertActionStyle.default, handler: self.deleteChildAction))
        self.present(alert, animated: true, completion: nil)
    }

    func deleteChildAction(_ sender: Any) {
        
        print("calling delete child....")
        self.showLoadingView()
        callForDeleteChild(children_id: self.idForDeleteChild, success: {
